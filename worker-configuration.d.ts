/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 568acebde06fb3578ea38b0a67b136fb)
...
interface __BaseEnv_Env {
	...
	PROGRESS_AGENT: DurableObjectNamespace<import("./src/worker/index").ProgressAgent>;
	BLOCKER_WORKFLOW: Workflow<Parameters<import("./src/worker/index").BlockerWorkflow['run']>[0]['payload']>;
	WEEKLY_WORKFLOW: Workflow<Parameters<import("./src/worker/index").WeeklyReviewWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "WorkspaceDO" | "ProgressAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROGRESS_AGENT_MODEL" | "HISTORY_EMBED_MODEL" | "BLOCKER_REMINDER_DELAY" | "BLOCKER_ESCALATION_DELAY" | "WEEKLY_STEP_TIMEOUT" | "WEEKLY_MAX_ROUNDS" | "AGENT_FAKE_AI">> {}
}
